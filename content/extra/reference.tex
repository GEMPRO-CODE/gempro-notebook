...
\begin{itemize}[leftmargin=*,label={}]
  ...
  \item \textbf{N\'umero de Narayana.}
  A quantidade de caminhos de $(0, 0)$ a $(N, N)$ que n\~ao passam acima da diagonal e com exatamente $M$ picos locais \'e 
  \[
  ...
  Dada uma sequ\^encia $A_1, A_2, \dots, A_n$ de n\'umeros tais que $A_i \le 1$ e $K = \sum{A_i} \ge 0$, o n\'umero de rota\c{c}\~oes c\'iclicas de $A$ tais que cada soma de prefixo \'e positiva \'e exatamente $K$.
  ...
  \item \textbf{Convolu\c{c}\~ao Min-Plus.}
	  A convolu\c{c}\~ao Min-Plus de duas sequ\^encias convexas pode ser calculada com greedy nas sequ\^encias de diferen\c{c}a.
	  A convolu\c{c}\~ao Min-Plus de duas sequ\^encias convexas tamb\'em \'e convexa.
\end{itemize}
...
\begin{itemize}[leftmargin=*,label={}]
  ...
  O n\'umero de \'arvores geradoras de um grafo \'e igual a qualquer cofator de sua matriz Laplaciana. (A matriz de graus - a matriz de adjac\^encia).
  ...
  \fi
  \item \textbf{UGV.}
  Considere o jogo de mover ao longo de arestas de um grafo sem poder repetir v\'ertices, e o jogador que n\~ao puder mover perde. O segundo jogador tem uma estrat\'egia vencedora sse existe um matching m\'aximo no grafo que deixa o v\'ertice inicial insaturado.
\end{itemize}
